...
e.preventDefault();
  ...
  if (zonecode === "") {
    document.querySelector(".code").innerText = "우편번호를 올바르게 입력해주세요!";
    isValid = false;
  } else {
...
e.preventDefault();
  ...
  if (errorname === "") {
    document.querySelector(".errorname").innerText = "성명을 올바르게 입력해주세요!";
    isValid = false;
  } else {
  ...
  if (errorphone === "") {
    document.querySelector(".errornum").innerText = "휴대폰 번호를 올바르게 입력해주세요!";
    isValid = false;
  } else {
